...
const T = {
  ...
  footer: { zh: '© 2026 新伦 · 免费在线计算器｜由KixTools提供', en: '© 2026 新伦 · Free Online Calculators | Powered by KixTools' },

  // Index
  indexTitle: { zh: '新伦智算 - 多功能免费在线计算器大全', en: '新伦 - Free Online Calculators & Tools' },
...
function renderHeader(active) {
  ...
  return `<header class="header"><div class="header-inner">
    <a href="index.html" class="logo">⚡ <span data-t="siteName">新伦</span></a>
...
function renderFooter() {
  ...
  <footer class="footer">© 2026 新伦 · 免费在线计算器｜由<a href="https://kixtools.com" target="_blank" rel="noopener" style="color:inherit;text-decoration:underline">KixTools</a>提供</footer>`;
}
